...
import (
	...
	goonvif "github.com/unm4sk1g/go-onvif"
	"github.com/unm4sk1g/go-onvif/device"
	"github.com/unm4sk1g/go-onvif/gosoap"
...
func main() {
	...
	if err != nil {
		...
		/*
			You could use https://github.com/unm4sk1g/go-onvif/gosoap for pretty printing response
		*/
